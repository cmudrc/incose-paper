...
populations = [10, 20, 30, 40]  # Agents population
household_sizes = [1, 5, 10]  # Agents/Homes (household size)
impact_types = ["critical", "random"]
impact_levels = [5, 15, 25]  # % of the elements removed
repetitions = 3  # How many times to repeat each experiment
steps = 1000  # Number of steps tp run the simulation
...
# Setup
step_size = 2 * 3600  # Step size in seconds
